...
function(test)
	...
	check_open(${DIR}/pool16 "1.7 1.8 1.9 1.10 1.11 1.12")

	# 1.7 -> 1.8
	execute(0 ${EXE_DIR}/pmdk-convert --to=1.8 ${DIR}/pool16 -X fail-safety)
	check_open(${DIR}/pool16 "1.7 1.8 1.9 1.10 1.11 1.12")

	# 1.8 -> 1.9
	execute(0 ${EXE_DIR}/pmdk-convert --to=1.9 ${DIR}/pool16 -X fail-safety)
	check_open(${DIR}/pool16 "1.7 1.8 1.9 1.10 1.11 1.12")

	# 1.9 -> 1.10
	execute(0 ${EXE_DIR}/pmdk-convert --to=1.10 ${DIR}/pool16 -X fail-safety)
	check_open(${DIR}/pool16 "1.7 1.8 1.9 1.10 1.11 1.12")

	# 1.10 -> 1.11
	execute(0 ${EXE_DIR}/pmdk-convert --to=1.11 ${DIR}/pool16 -X fail-safety)
	check_open(${DIR}/pool16 "1.7 1.8 1.9 1.10 1.11 1.12")

	# 1.11 -> 1.12
	execute(0 ${EXE_DIR}/pmdk-convert --to=1.12 ${DIR}/pool16 -X fail-safety)
	check_open(${DIR}/pool16 "1.7 1.8 1.9 1.10 1.11 1.12")
endfunction(test)
