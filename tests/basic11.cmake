...
function(test)
	...
	check_open(${DIR}/pool11 "1.7 1.8 1.9 1.10 1.11 1.12")
	...
	# 1.10 -> 1.11
	execute(0 ${EXE_DIR}/pmdk-convert --to=1.11 ${DIR}/pool11 -X fail-safety)
	check_open(${DIR}/pool11 "1.7 1.8 1.9 1.10 1.11 1.12")

	# 1.11 -> 1.12
	execute(0 ${EXE_DIR}/pmdk-convert --to=1.12 ${DIR}/pool11 -X fail-safety)
	check_open(${DIR}/pool11 "1.7 1.8 1.9 1.10 1.11 1.12")
endfunction(test)
